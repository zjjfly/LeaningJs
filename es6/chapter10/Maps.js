...
(function () {
    "use strict";
    //es6之前,我们一般用object代替map，但它缺点很多，比如原型的存在、不易知道到底有多少映射、键必须是字符串或Symbol等
    //es6引入的Map解决了这些问题
    ...
    console.log([...userRoles.values()]);//使用...把values放入数组(而不是一个可以遍历的对象)
    // 删除一个键值对
