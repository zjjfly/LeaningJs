...
console.log(input.includes("going"));//类似java的contains
...
//替换
const output1=input.replace(/going/,"walking");//使用正则,类似java的replaceAll
console.log(output1);
const output2=input.replace("going","walking");//使用字符串,类似java的replace
console.log(output2);
